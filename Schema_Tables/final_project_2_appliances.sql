...
CREATE TABLE `appliances` (
  ...
  CONSTRAINT `appliances_ibfk_1` FOREIGN KEY (`productID`) REFERENCES `product` (`productID`) ON DELETE CASCADE
...
INSERT INTO `appliances` VALUES (9,'LG'),(10,'LG'),(11,'Dyson'),(12,'LG');
