...
CREATE TABLE `electronics` (
  ...
  CONSTRAINT `electronics_ibfk_1` FOREIGN KEY (`productID`) REFERENCES `product` (`productID`) ON DELETE CASCADE
...
INSERT INTO `electronics` VALUES (1,150),(2,5),(3,30),(4,15),(5,75),(6,5),(7,45),(8,60);
