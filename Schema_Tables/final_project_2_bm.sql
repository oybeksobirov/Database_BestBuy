...
CREATE TABLE `bm` (
  ...
  PRIMARY KEY (`storeID`),
  CONSTRAINT `bm_ibfk_1` FOREIGN KEY (`storeID`) REFERENCES `store` (`storeID`) ON DELETE CASCADE
...
INSERT INTO `bm` VALUES (1,'1201 Best Buy Blvd','Los Angeles','CA'),(2,'450 Tech Ave','New York','NY'),(3,'800 Gadget Rd','Chicago','IL'),(4,'999 Electronics Way','Houston','TX'),(5,'300 Pacific St','Seattle','WA');
